...
```bash
pnpm --filter @inoks-story-webnovel/core test    # Core tests only
pnpm --filter @inoks-story-webnovel/cli test         # CLI tests only
```
...
Open an issue or check existing ones: https://github.com/jiangyuer018/inoks-story-webnovel/issues
