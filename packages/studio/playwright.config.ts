...
export default defineConfig({
  testDir: "./e2e",
  // Rebuild @inoks-story-webnovel/core before starting the E2E server.  The API server
  ...
  // Always start a dedicated E2E server with INOKS_STORY_AGENT_LLM_STUB=1 so the
  ...
  webServer: {
    command: "INOKS_STORY_AGENT_LLM_STUB=1 INOKS_STORY_STUDIO_PORT=4581 INOKS_STORY_PROJECT_ROOT=../../test-project tsx watch --clear-screen=false src/api/index.ts & INOKS_STORY_AGENT_LLM_STUB=1 INOKS_STORY_STUDIO_PORT=4581 vite --host --port 4580 ; kill %1 2>/dev/null",
