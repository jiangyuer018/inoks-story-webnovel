...
import type { BookCreationDraft } from "@inoks-story-webnovel/core";
...
const PAGE_COPY: Record<"zh" | "en", PlatformCopy> = {
  ...
  en: {
    ...
    idleBody: "Fill in the title, genre, and story core first. Inoks Story Webnovel will generate the foundation and open the new workspace.",
