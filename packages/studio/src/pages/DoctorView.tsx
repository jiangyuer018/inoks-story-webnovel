...
interface DoctorChecks {
  readonly inoksStoryJson: boolean;
    ...
    <div className="space-y-8">
      ...
      {!data ? (
        ...
        <div className={`border ${c.cardStatic} rounded-lg p-5`}>
          <CheckRow label={t("doctor.projectConfig")} ok={data.inoksStoryJson} />
      ...
      {data && (
        <div className={`px-4 py-3 rounded-lg text-sm font-medium ${
          data.inoksStoryJson && (data.projectEnv || data.globalEnv) && data.llmConnected
