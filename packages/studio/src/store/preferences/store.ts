...
// Same storage convention as the theme preference (`inoks-story:studio:theme`).
export const TOOL_DETAILS_STORAGE_KEY = "inoks-story:studio:tool-details-default-open";
