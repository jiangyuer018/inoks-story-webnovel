...
const strings = {
  ...
  "nav.createPlay": { zh: "Inoks Story Webnovel 互动", en: "Inoks Story Webnovel Play" },
  ...
  "doctor.projectConfig": { zh: "项目配置", en: "Project configuration" },
  "doctor.projectEnv": { zh: "项目 .env 文件", en: "Project .env file" },
  "doctor.globalEnv": { zh: "全局 ~/.inoks-story-webnovel/.env", en: "Global ~/.inoks-story-webnovel/.env" },
