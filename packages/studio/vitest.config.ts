...
export default defineConfig({
  resolve: {
    alias: {
      ...
      "@inoks-story-webnovel/core/interactive-film/evaluator": resolve(__dirname, "../core/src/interactive-film/evaluator.ts"),
      "@inoks-story-webnovel/core/interactive-film/graph-schema": resolve(__dirname, "../core/src/interactive-film/graph-schema.ts"),
      "@inoks-story-webnovel/core/forecast/schema": resolve(__dirname, "../core/src/forecast/schema.ts"),
      "@inoks-story-webnovel/core": resolve(__dirname, "../core/src/index.ts"),
    },
  },
  test: {
    include: ["src/**/*.test.ts"],
