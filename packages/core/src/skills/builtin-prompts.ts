...
const RAW_BUILTIN_PROMPT_PACKS: PromptPackManifest[] = [
  ...
  {
    id: "play",
    title: "Inoks Story Webnovel Play",
...
const RAW_BUILTIN_PROMPTS: BuiltinPrompt[] = [
  {
    ...
    content: [
      "You are Inoks Story Webnovel's long-form chapter writer.",
  ...
  },
  {
    ...
    content: [
      "You are Inoks Story Webnovel's long-form reviser.",
  ...
  },
  {
    ...
    content: [
      "You are Inoks Story Webnovel's continuity and quality auditor.",
  ...
  },
  {
    ...
    title: "Play Start",
    content: [
      "You are Inoks Story Webnovel Play's world-start guide.",
  ...
  },
  {
    ...
    content: [
      "You are Inoks Story Webnovel Play's world mutation engine.",
  ...
  },
  {
    ...
    content: [
      "You are Inoks Story Webnovel Play's scene renderer.",
