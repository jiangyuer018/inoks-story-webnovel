...
import {
  buildCoreProseQualityConstraints,
  PROSE_NATURALIZER_SYSTEM_PROMPT,
} from "../prose-quality/prompt.js";
import type { GenreProfile } from "../models/genre-profile.js";
import type { BookRules } from "../models/book-rules.js";
import type { LengthSpec } from "../models/length-governance.js";
import type { AuditIssue } from "./continuity.js";
import type { ChapterIntent, ChapterMemo, ContextPackage, RuleStack } from "../models/input-governance.js";
import type { MemoryContextPackage } from "../story-system/types.js";
...
export type ReviseMode = "auto" | "polish" | "rewrite" | "rework" | "anti-detect" | "spot-fix" | "prose-quality";
...
9. 消灭"不禁""仿佛""宛如"等AI标记词：换成具体感官描写`,
  ...
  "prose-quality": PROSE_NATURALIZER_SYSTEM_PROMPT,
};
...
export class ReviserAgent extends BaseAgent {
  ...
  async reviseChapter(
    ...
    options?: {
      ...
      longFormMemory?: MemoryContextPackage;
    },
    ...
    const styleGuideBlock = reducedControlBlock.length === 0
      ? `\n## 文风指南\n${styleGuide}`
      : "";
    const longFormMemoryBlock = options?.longFormMemory
      ? `\n## Inoks Story Webnovel Long-form Memory（protected facts override summaries）\n${JSON.stringify(options.longFormMemory)}\n`
      : "";
...
## 当前状态卡
${currentState}
${longFormMemoryBlock}${ledgerBlock}
