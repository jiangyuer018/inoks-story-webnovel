...
import { PipelineRunner, StateManager, resolveChapterReviewMode } from "@inoks-story-webnovel/core";
  ...
  .action(async (args: ReadonlyArray<string>, opts) => {
    ...
    try {
      ...
      if (args.length === 1) {
        ...
        throw new Error("Usage: inoks-story write rewrite [book-id] <chapter>");
      }
  ...
  .action(async (args: ReadonlyArray<string>, opts) => {
    try {
      ...
      if (args.length === 1) {
        ...
        throw new Error("Usage: inoks-story write sync [book-id] <chapter>");
      }
  ...
  .action(async (args: ReadonlyArray<string>, opts) => {
    try {
      ...
      if (args.length === 1) {
        ...
        throw new Error("Usage: inoks-story write repair-state [book-id] <chapter>");
      }
